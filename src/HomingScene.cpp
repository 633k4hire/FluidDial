...
private:
    ...
    void draw_lathe_home() {
        ...
        for (int axis = 0; axis < 3; ++axis) {
            ...
            if (axis == 2) {
                lathe_ui_badge(113, y - 11, 70, "N/A", lathe_ui_muted());
            } else {
                ...
                lathe_ui_badge(94, y - 11, 100, value, color);
            }
        }

        const char* selected = _axis_to_home < 0 ? "ALL X/Z" : _axis_to_home == 0 ? "X AXIS" : "Z AXIS";
        lathe_ui_badge(70, 182, 100, selected, lathe_ui_blue());
        ...
        if (state == Homing) {
            ...
            centered_text("HOME UNAVAILABLE", 207, lathe_ui_amber(), TINY);
            red_label = "E-Stop";
        ...
        drawButtonLegends(red_label, green_label, center_label);
        refreshDisplay();
    }
